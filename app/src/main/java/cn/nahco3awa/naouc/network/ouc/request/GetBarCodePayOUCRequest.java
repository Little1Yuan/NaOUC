...
import synjones.commerce.utils.RSASign;
import synjones.commerce.utils.SignUtils;
...
public class GetBarCodePayOUCRequest implements OUCRequest {
    ...
    public Request makeRequest(OUCRequestSender sender) {
        ...
        jsonObject.addProperty("flag", "01");
        ...
        String timestamp = URLEncoder.encode(SimpleDateFormat.getDateTimeInstance().format(new Date(System.currentTimeMillis())));
